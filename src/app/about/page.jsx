...
const AboutPage = () => {
  ...
  return (
    ...
    >
      ...
      // className="h-full bg-gradient-to-b from-orange-200 to blue-100 overflow-scroll lg:flex" ref={containerRef}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Trabaje en diversos proyectos con React y Redux como Freelancer.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-600 text-sm font-semibold">
                    2023 - 2024{" "}
